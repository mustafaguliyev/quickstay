    ...
    return (
        <div className="">
            <Title
                ...
                subTitle="View,edit,or manage all listed rooms.Keep the 
information up-to-date to provide the best experience"
            />
                            ...
                            {room.map((item, index) => (
                                <tr key={index}>
                                 ...
                                 <label className="relative inline-flex items-center cursor-pointer text-gray-900 gap-3">
                                    ...
                                    <div className="w-12 h-7 bg-blue-400 rounded-full perr perr-checked:bg-blue-600 transition-colors duration-200">
