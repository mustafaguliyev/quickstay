...
function AllRooms() {
    ...
    return (
        <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:px-16 lg:px-24 xl:px-32'>
            ...
            {/* FILTERS */}
            <div className='bg-white w-80 border border-gray-300 text-gray-600 max-lg:mb-8 min-lg:mt-16 rounded-2xl shadow-md'>
                <div className='flex items-center justify-between px-5 py-3 border-b border-gray-200'>
                    ...
                    <div className='text-xs cursor-pointer'>
                        ...
                        <span className='hidden lg:block hover:text-primary'>Clear</span>
                    </div>
                </div>

                {/* CONTENT */}
                <div className={`${openFilters ? 'block' : 'hidden'} lg:block transition-all`}>
